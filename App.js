  ...
  return (
    ...
    >
      ...
      <SafeAreaView className="flex-1">
        <View style={{ height: "7%", zIndex: 5 }} className="mx-4 relative">
          <View className="flex-row justify-end items-end rounded-full bg-white/20 mt-5">
            ...
            {/* <TouchableOpacity className="" onPress={handleSearch}>
              <Text className="bg-green-500 px-3 py-2 rounded-full text-base text-white items-center justify-center font-medium">
                Search
              </Text>
            </TouchableOpacity> */}
          </View>
        ...
        {/* Focus Section */}
        <View className="mx-4 justify-around flex-1 mb-2" style={{ zIndex: 2 }}>
          ...
          <View className="flex-row justify-between mx-4">
            ...
            <View className="flex-row space-x-2 items-center">
              <Image source={require("./assets/sun.png")} className="w-6 h-6" />
              <Text className="text-white font-semibold text-base">
                6:05 AM
              </Text>
            </View>
